...
__webpack_require__.d(__webpack_exports__, {
  DataPaging: () => (/* reexport */ DataPaging),
  DataTable: () => (/* reexport */ DataTable),
  InputDate: () => (/* reexport */ InputDate),
  InputMask: () => (/* reexport */ InputMask),
  InputMoney: () => (/* reexport */ InputMoney),
...
var jquery_ui = __webpack_require__(660);
// EXTERNAL MODULE: ./src/assets/jquery/js/jquery.maskedinput.js
var jquery_maskedinput = __webpack_require__(360);
...
const _hoisted_2 = { class: "fschaptertable" }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", _hoisted_1, [
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("table", _hoisted_2, [
      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("tr", _hoisted_3, [
        (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("td", _hoisted_4, [
          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", _hoisted_5, [
            (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("ul", {
              class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.pageCSS.ulCSS)
            }, [
              ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($setup.pager, (item, index) => {
                return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("li", {
                  key: index,
                  class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)([$setup.pageCSS.liCSS, item.css])
                }, [
                  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_A, {
                    HREF: "javascript:void(0)",
                    onClick: $event => ($options.pageSelect(item)),
                    class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)([$setup.pageCSS.aCSS, item.css]),
                    "data-paging": item.page
                  }, {
                    default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [
                      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)((0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(item.text), 1)
                    ]),
                    _: 2
...
const DataTablevue_type_template_id_134949d6_hoisted_3 = /*#__PURE__*/(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("em", {
  class: "fa fa-bolt",
  "aria-hidden": "true"
}, null, -1)
...
function DataTablevue_type_template_id_134949d6_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("table", {
    class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.headers.tableCSS)
  }, [
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("thead", {
      class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.headers.headCSS)
    }, [
      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("tr", {
        class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.headers.headRowCSS)
      }, [
        ($options.hasSequence)
          ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("th", {
              key: 0,
              class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.headers.headSeqCSS)
            }, [
        ...
        ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($setup.headers.columns, (item, index) => {
          return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, { key: index }, [
            (item.sorter)
              ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("th", {
                  key: 0,
                  class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.headers.headColCSS)
                }, [
                  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_A, {
                    href: "javascript:void(0)",
        ...
        ($options.hasActions)
          ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("th", {
              key: 1,
              class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.headers.headActionCSS)
            }, DataTablevue_type_template_id_134949d6_hoisted_4, 2))
          : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true)
      ], 2)
    ], 2),
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("tbody", {
      class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.headers.bodyCSS)
    }, [
      ($options.hasDataSet)
        ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, { key: 0 }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($setup.datas?.rows, (item, index) => {
            return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("tr", {
              key: index,
              class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)($setup.headers.rowCSS)
            }, [
              ($options.hasSequence)
                ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("td", DataTablevue_type_template_id_134949d6_hoisted_5, [
                    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("label", null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($setup.page.recordsNumber(index+1)), 1)
                  ]))
                : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true),
              ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($setup.headers.columns, (column, colIndex) => {
                  ...
                  ($setup.headers.defaultAction)
                    ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("a", {
                        ...
                        (column.unescape)
                          ...
                          : ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("span", _hoisted_8, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($options.formatData(item[column.name],column,item)), 1))
                      ], 8, _hoisted_6))
                    : ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, { key: 1 }, [
                        (column.unescape)
                          ...
                          : ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("span", _hoisted_10, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($options.formatData(item[column.name],column,item)), 1))
                      ], 64))
                ], 2))
              }), 128)),
              ($options.hasActions)
                ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("td", _hoisted_11, [
                    ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($setup.headers.actions, (action, actionIndex) => {
                      return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, { key: actionIndex }, [
                        (action.render)
                          ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, { key: 0 }, [
                              ((_ctx.actioner = action.render(item)))
                                ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, { key: 0 }, [
                                    (_ctx.actioner.type=='button')
                                      ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("button", {
                                          key: 0,
                                          class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)(_ctx.actioner.css),
                                          onClick: $event => ($options.dataSelect(item,action.render(item).action))
                                        }, [
                                          (_ctx.actioner.icon)
                                            ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("em", {
                                                key: 0,
                                                class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)(_ctx.actioner.icon)
                                              }, null, 2))
                                            : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true)
                                        ], 10, _hoisted_12))
                                      : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true),
                                    (_ctx.actioner.type=='a')
                                      ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_A, {
                                          key: 1,
                                          href: "javascript:void(0)",
                                          class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)(["alink-action", _ctx.actioner.css]),
                                          onClick: $event => ($options.dataSelect(item,action.render(item).action))
                                        }, {
                                          default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [
                                            (_ctx.actioner.icon)
      ...
      ($options.recordNotFound)
        ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("tr", _hoisted_14, [
            (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("td", {
              class: "text-center",
              colspan: $options.columnCount
            }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($props.labels.record_notfound), 9, _hoisted_15)
          ]))
        : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true)
    ], 2)
  ], 2))
...
/* harmony default export */ const DataTablevue_type_script_lang_js = ({
  props: {
    labels: Object,
    dataset: {
      type: Object,
  ...
  setup(props) {
    const datas = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)({ ...props.dataset }); 
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/controls/InputDate.vue?vue&type=script&lang=js




/* harmony default export */ const InputDatevue_type_script_lang_js = ({
...
/* harmony default export */ const InputMaskvue_type_script_lang_js = ({
  props: {
    modelValue: String,
    id: {
      type: String,
...
/* harmony default export */ const InputMoneyvue_type_script_lang_js = ({
  props: {
...
/* harmony default export */ const InputNumbervue_type_script_lang_js = ({
  props: {
    modelValue: [String, Number],
    id: {
      type: String,
  ...
  mounted() {
    let element = document.getElementById(this.id);
    jquery_default()(element).on("keypress",function(event) { return inputNumberOnly(this,event); });
  },
  emits: ['update:modelValue'],
  computed: {
    model: {
...
/* harmony default export */ const InputTimevue_type_script_lang_js = ({
  props: {
    modelValue: String,
    id: {
      type: String,
  ...
  mounted() {
    let element = document.getElementById(this.id);
    jquery_default()(element).clockpicker({ align: "left", autoclose: true, donetext: "Done", cleartext: "Clear", 
				afterDone: function() {
...
const LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_1 = { class: "loading-layer" }
const LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_2 = { class: "loading-span" }
const LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_3 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("em", { class: "fa fa-spinner fa-spin" }, null, -1))
const LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_4 = [
  LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_3
]
...
function LoadingPagevue_type_template_id_844669f2_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withDirectives)(((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_1, [
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withDirectives)((0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_2, LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_4, 512), [
      [external_commonjs_vue_commonjs2_vue_root_Vue_.vShow, $props.animate]
    ]),
    LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_5,
    LoadingPagevue_type_template_id_844669f2_scoped_true_hoisted_6,
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/controls/LoadingPage.vue?vue&type=script&lang=js

/* harmony default export */ const LoadingPagevue_type_script_lang_js = ({
    props: {
        visible: {
            type: [String,Boolean],
            default: true,
...
/* harmony default export */ const LoadingPage = (LoadingPage_exports_);
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/controls/PageHeader.vue?vue&type=template&id=bd96eda8


const PageHeadervue_type_template_id_bd96eda8_hoisted_1 = { class: "header-layer" }
const PageHeadervue_type_template_id_bd96eda8_hoisted_2 = { class: "program-controlbar navbar navbar-expand-sm navbar-top navbar-header-title" }
const PageHeadervue_type_template_id_bd96eda8_hoisted_3 = { class: "page-header-title" }
const PageHeadervue_type_template_id_bd96eda8_hoisted_4 = { class: "navbar-header" }
const PageHeadervue_type_template_id_bd96eda8_hoisted_5 = { class: "navbar-nav navbar-right ml-auto program-control-layer" }
const PageHeadervue_type_template_id_bd96eda8_hoisted_6 = { class: "dropdown user-dropdown" }
const PageHeadervue_type_template_id_bd96eda8_hoisted_7 = {
  key: 0,
  class: "dropdown-menu dropdown-menu-right page-header-menu"
}
const PageHeadervue_type_template_id_bd96eda8_hoisted_8 = ["onClick"]
const PageHeadervue_type_template_id_bd96eda8_hoisted_9 = { class: "menu-separator" }
const PageHeadervue_type_template_id_bd96eda8_hoisted_10 = { key: 1 }
const PageHeadervue_type_template_id_bd96eda8_hoisted_11 = /*#__PURE__*/(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("em", {
  class: "fa fa-info-circle fa-class",
  "aria-hidden": "true"
}, null, -1)
const PageHeadervue_type_template_id_bd96eda8_hoisted_12 = {
  key: 2,
  class: "build-version"
}
const PageHeadervue_type_template_id_bd96eda8_hoisted_13 = /*#__PURE__*/(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("em", {
  class: "fa fa-at fa-class",
  "aria-hidden": "true"
}, null, -1)

function PageHeadervue_type_template_id_bd96eda8_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_A = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.resolveComponent)("A")

  return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", PageHeadervue_type_template_id_bd96eda8_hoisted_1, [
    (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("nav", PageHeadervue_type_template_id_bd96eda8_hoisted_2, [
      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("h1", PageHeadervue_type_template_id_bd96eda8_hoisted_3, [
        (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", PageHeadervue_type_template_id_bd96eda8_hoisted_4, [
          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("label", null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($props.labels.caption_title), 1)
        ])
      ]),
      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("ul", PageHeadervue_type_template_id_bd96eda8_hoisted_5, [
        (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("li", PageHeadervue_type_template_id_bd96eda8_hoisted_6, [
          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_A, {
            href: "javascript:void(0)",
            ...
            default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [
              (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($options.pageId), 1)
            ]),
            _: 1
          }),
          ($options.displayMenu)
            ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("ul", PageHeadervue_type_template_id_bd96eda8_hoisted_7, [
                (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderSlot)(_ctx.$slots, "default"),
                ($options.displayLanguage)
                  ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, { key: 0 }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($props.multiLanguages, (item) => {
                      return ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("li", {
                        key: item.lang
                      }, [
                        (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("a", {
                          ...
                          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", {
                            class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)({'item-selected' : $setup.currentLanguage == item.lang})
                          }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($props.labels[item.label]), 3)
                        ], 8, PageHeadervue_type_template_id_bd96eda8_hoisted_8)
                      ]))
                    }), 128))
                  : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true),
                (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withDirectives)((0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("hr", PageHeadervue_type_template_id_bd96eda8_hoisted_9, null, 512), [
                  [external_commonjs_vue_commonjs2_vue_root_Vue_.vShow, $options.displayVersion && $options.displayLanguage]
                ]),
                ($options.displayVersion)
                  ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("li", PageHeadervue_type_template_id_bd96eda8_hoisted_10, [
                      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_A, {
                        href: "javascript:void(0)",
                        ...
                        default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [
                          PageHeadervue_type_template_id_bd96eda8_hoisted_11,
                          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)(" "),
                          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($props.labels.version_label) + " " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($props.version), 1)
                        ]),
                        _: 1
                      }, 8, ["onClick"])
                    ]))
                  : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true),
                ($options.displayBuild)
                  ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("li", PageHeadervue_type_template_id_bd96eda8_hoisted_12, [
                      (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_A, {
                        href: "javascript:void(0)",
                        class: "pagemenu-linker"
                      }, {
                        default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [
                          PageHeadervue_type_template_id_bd96eda8_hoisted_13,
                          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)(" "),
                          (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($setup.buildVersion), 1)
                        ]),
                        _: 1
                      })
                    ]))
...
;// CONCATENATED MODULE: ./src/controls/PageHeader.vue?vue&type=template&id=bd96eda8

;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/controls/PageHeader.vue?vue&type=script&lang=js



const buildVersion = ({"NODE_ENV":"production","VUE_APP_API_TOKEN":"","VUE_APP_API_URL":"","VUE_APP_BASE_STORAGE":"session","VUE_APP_BASE_URL":"","VUE_APP_CDN_URL":"","VUE_APP_DEFAULT_LANGUAGE":"EN","VUE_APP_DEFAULT_RAW_PARAMETERS":"false","VUE_APP_IMG_URL":"","BASE_URL":"/"}).VUE_APP_BUILD_DATETIME;
/* harmony default export */ const PageHeadervue_type_script_lang_js = ({
  props: {
    pid: String,
    labels: Object,
    version: {
  ...
  computed: {
    ...
    isAlertBuild() { return Utilities/* Utilities */.F.parseBoolean(this.$props.alertBuild); },
    displayBuild() { return Utilities/* Utilities */.F.parseBoolean(this.$props.showBuild); },
    displayVersion() { return Utilities/* Utilities */.F.parseBoolean(this.$props.viewVersion); },
    displayLanguage() { return Utilities/* Utilities */.F.parseBoolean(this.$props.showLanguage); },
    displayMenu() { 
...
;// CONCATENATED MODULE: ./src/controls/PageHeader.vue?vue&type=style&index=0&id=bd96eda8&lang=css
...
const PageHeader_exports_ = /*#__PURE__*/(0,exportHelper/* default */.A)(PageHeadervue_type_script_lang_js, [['render',PageHeadervue_type_template_id_bd96eda8_render]])
